...
const STEPS = [
  {
    ...
    body: 'Hydra runs a 9-step pipeline — 4 LLM reasoning agents plus automation steps — that discovers roles, tailors your resume and cover letter, then queues everything for your approval. Nothing is submitted without you.',
    accent: '#06b6d4',
    visual: (
  ...
  },
  {
    ...
    body: 'Every scan checks 14 live sources — all free, no API keys needed. Trigger a run from INTEL in the top nav. Matched roles flow straight into the pipeline and Review Queue.',
    accent: '#06b6d4',
    visual: (
      <div style={{ display: 'flex', gap: '6px', flexWrap: 'wrap', marginTop: '12px' }}>
