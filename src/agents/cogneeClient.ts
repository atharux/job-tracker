...
// localJobSearch and its types moved behind the context-assistant seam (#21).
// Re-exported here so existing importers keep working unchanged.
export { localJobSearch } from './contextAssistant'
export type {
  AssistantLink as JobSearchLink,
  AssistantResult as JobSearchResult,
} from './contextAssistant'
