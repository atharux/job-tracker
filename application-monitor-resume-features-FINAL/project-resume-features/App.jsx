...
const applyGamification = async (action, actionData = {}) => {
  ...
  try {
    ...
    // 4ï¸âƒ£ If no row exists â†’ create one with correct values
    ...
    // 5ï¸âƒ£ Normalize existing row if needed
    const needsUpdate =
            ...
            <tbody>
              ${applications.map(app => `
                <tr>
                  ...
                  <td>${app.contact_person || 'Ã¢â‚¬â€'}</td>
                  <td>${app.status}</td>
                  <td>${app.notes}</td>
                </tr>
              `).join('')}
              ...
              {filteredApplications.length === 0 ? (
                ...
                filteredApplications.map(app => (
                  <tr key={app.id}>
                    ...
                    <td className="contact">{app.contact_person || 'Ã¢â‚¬â€'}</td>
                    <td>
